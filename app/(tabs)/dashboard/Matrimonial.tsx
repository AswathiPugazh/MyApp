...
export default function Matrimonial() {
  ...
  const fetchData = async () => {
    try {
      const response = await axios.get('https://celebratingar2024.com/mobile/Backend/Matrimonial_AllProfiles.php?refresh=' + Math.random());
          ...
          <FlatList
            ...
            renderItem={({ item }) => (
              <View style={styles.item}>
                ...
                <TouchableOpacity onPress={() => handlePreviewFile(`https://celebratingar2024.com/mobile/Backend/${item.jathagam_file_path}`)}>
